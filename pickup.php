...
try {
    ...
    $stmt = $db->prepare("INSERT INTO claim_takeout (claim, date_time) SELECT pickup_num, ? FROM pickup WHERE ID IN ($placeholders)");
    ...
    $stmt = $db->prepare("DELETE FROM pickup WHERE ID IN ($placeholders)");
