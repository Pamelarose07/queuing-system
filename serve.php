...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Your PDO connection
    $db = new PDO("odbc:Driver={Microsoft Access Driver (*.mdb, *.accdb)};Dbq=c:\\Restrnt\\Data-KDS\\TakeoutDB.mdb; Uid=; Pwd=;");

    // Your SQL insert statement
    $sqlInsert = "INSERT INTO TakeOut (Note) VALUES (:num)";
            ...
            <div class="h-screen shadow p-5 rounded-lg border-4 border-red-700 bg-white">
                ...
                <div class="scrollable-container" style="height: 530px; overflow-y: auto;">
                    <div class="grid grid-cols-2">
                        ...
                        <div class="b" onclick="highlightNumber(this)" onselectstart="return false;">
                            <div style="font-size: 38px; margin-left:10px;" class="font-bold hover:text-red-500"></div>
                        </div>
                ...
                <div class="scrollable-container" style="height: 530px; overflow-y: auto;">
                    <div class="grid grid-cols-1">
                        <?php foreach ($result_claim->fetchAll() as $key => $row) { ?>
                            <div class="b" onclick="highlightNumber(this)" id="<?php echo $row['ID']; ?>" onselectstart="return false;">
                                <div style="font-size: 20px; margin-left:10px;" class="font-bold hover:text-red-500">
